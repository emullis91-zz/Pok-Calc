...
# these two globals represent groups of statuses that confer identical catch chance bonuses across 
# all generations' differing calculation methods (i.e. sleeping and frozen Pokemon are always equally easy
# to catch, and easier to catch than burned, poisoned, or paralyzed pokemon; assuming all other relevant
# variables are equal).
TIER_1_STATUSES = ("burn", "poison", "paralyze")
...
class Gen3_4Calc(CatchCalc):    
    ...
    def catch_chance(self):
        ...
        a = ((3*self.maxhp - 2*self.currhp)*self.catchrate*BALL_BONUS[self.ball]*status_bonus)/(3*self.maxhp)     
